...
// To be used each time the button handler is called
...
void GPIOJ_Handler(void){
  ...
  // Only proceed if there is space available, otherwise, do not block ISR
  if(osSemaphoreAcquire(empty_id, 0) == osOK){
